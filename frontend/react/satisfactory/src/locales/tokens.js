export const tokens = {
  ...
  "dashboard": {
    "common": {
      "languageChanged": "dashboard:common.languageChanged"
    },
    "nav": {
      "academy": "dashboard:nav.academy",
      "account": "dashboard:nav.account",
      "analytics": "dashboard:nav.analytics",
      "auth": "dashboard:nav.auth",
      "blog": "dashboard:nav.blog",
      "browse": "dashboard:nav.browse",
      "calendar": "dashboard:nav.calendar",
      "chat": "dashboard:nav.chat",
      "checkout": "dashboard:nav.checkout",
      "concepts": "dashboard:nav.concepts",
      "contact": "dashboard:nav.contact",
      "course": "dashboard:nav.course",
      "create": "dashboard:nav.create",
      "crypto": "dashboard:nav.crypto",
      "customers": "dashboard:nav.customers",
      "dashboard": "dashboard:nav.dashboard",
      "details": "dashboard:nav.details",
      "ecommerce": "dashboard:nav.ecommerce",
      "edit": "dashboard:nav.edit",
      "error": "dashboard:nav.error",
      "feed": "dashboard:nav.feed",
      "fileManager": "dashboard:nav.fileManager",
      "finance": "dashboard:nav.finance",
      "fleet": "dashboard:nav.fleet",
      "forgotPassword": "dashboard:nav.forgotPassword",
      "invoiceList": "dashboard:nav.invoiceList",
      "jobList": "dashboard:nav.jobList",
      "kanban": "dashboard:nav.kanban",
      "list": "dashboard:nav.list",
      "login": "dashboard:nav.login",
      "logistics": "dashboard:nav.logistics",
      "mail": "dashboard:nav.mail",
      "management": "dashboard:nav.management",
      "orderList": "dashboard:nav.orderList",
      "overview": "dashboard:nav.overview",
      "pages": "dashboard:nav.pages",
      "postCreate": "dashboard:nav.postCreate",
      "postDetails": "dashboard:nav.postDetails",
      "postList": "dashboard:nav.postList",
      "pricing": "dashboard:nav.pricing",
      "productList": "dashboard:nav.productList",
      "profile": "dashboard:nav.profile",
      "register": "dashboard:nav.register",
      "resetPassword": "dashboard:nav.resetPassword",
      "socialMedia": "dashboard:nav.socialMedia",
      "verifyCode": "dashboard:nav.verifyCode"
    }
  },
  "satisfactory": {
