  ...
  return (
    <>
      ...
      <p>
        ...
        conditions. Do not continue to use {title} if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing {title}, you agreed to use
        cookies in agreement with the
      ...
      <p>
        Unless otherwise stated, {url} and/or its licensors own the intellectual
        property rights for all material on
        {title}. All intellectual property rights are reserved. You may access
        this from {title} for your own personal use subjected to restrictions
      ...
      <p>
        ...
        {url} does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of {url},its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, {url} shall not be liable for the Comments
      ...
      <p>
        {url} reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant {url} a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        {url}; and (d) the link is in the context of general resource
        information.
      </p>
      ...
      <p>
        ...
        e-mail to {url}. Please include your name, your organization name,
      ...
      <p>
        No use of {url}'s logo or other artwork will be allowed for linking
