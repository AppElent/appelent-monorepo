...
client = CosmosClient("https://cdb-appelent.documents.azure.com:443/", access_key)
...
def get_access_token(request, name):
    ...
    authorization_response = request.get_full_path() if savedstate.get("authorization_response") is None else savedstate.get("authorization_response")
